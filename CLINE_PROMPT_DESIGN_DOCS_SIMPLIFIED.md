# Simplified Cline Prompt: Generate Design Documentation

Copy and paste this into Cline to generate design documents for the Amazon T Levels Hub project.

---

## PROMPT START

Create comprehensive design documents for the Amazon T Levels Hub web application at:
`c:\Users\far24238616\OneDrive - University College Birmingham\amazon(chatbot)\AMAZONIAN\AMAZONIAN\AMAZON`

**Tech Stack:** HTML/CSS/JavaScript (frontend), Node.js/Express (backend), SQLite (database)

Save output to: `documentation/DESIGN_DOCUMENTS.md`
